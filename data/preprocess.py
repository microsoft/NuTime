...
def mergeDatasets(dataset_dir_list: dict, save_dir: str, grain=10000):
...
if __name__ == "__main__":
    # prepareEpilepsy("/home/covpreduser/Blob/xumeng/data/time_series/epilepsy_origin")
    # prepareUCR(dataset_dir="/home/covpreduser/Blob/xumeng/data/time_series/UCRArchive_2018",
    #             fill_missing_and_variable=True, normalize=False, test_ratio=0.3, grain=10000)
    # prepareUEA(dataset_dir="/home/covpreduser/Blob/xumeng/data/time_series/Multivariate_arff")
    # prepareSleepEDF(dataset_dir="/home/covpreduser/Blob/xumeng/data/time_series/physionet.org/files/sleep-edfx/1.0.0")

    # merge all datasets
    # dataset_dir_dict = {
    #     '/home/covpreduser/Blob/xumeng/data/time_series/uea-30': 'multi',
    #     '/home/covpreduser/Blob/xumeng/data/time_series/ucr-128': 'multi',
    #     '/home/covpreduser/Blob/xumeng/data/time_series/TFC-datasets': 'multi',
    # }
    # save_dir = '/home/covpreduser/Blob/xumeng/data/time_series/'
    # mergeDatasets(dataset_dir_dict, save_dir, grain=100000)

    # construct anomaly detection for FD-B
    for s in range(1, 6):
        prepareAnomalyDataset(
            data_dir="/home/xumengwen/Blob/xumeng/data/time_series/TFC-datasets/FD-B",
            save_dir=f"/home/xumengwen/Blob/xumeng/data/time_series/AnomalyDetection/FD-B/s{s}",
            seed=s)