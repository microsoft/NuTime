...
class Config(object):
    def __init__(self):
        ...
        self.device = None
        self.log_dir = './'
        self.log_file = self.log_dir + '/test_log'
        ...
        self.transformer_mask_type = 'none' # 'learnable' 'drop'
...
def get_config_from_file():
    ...
    # test_config
    parser.add_argument('--config_file', type=str, required=False, default='./configs/default_cls.json')
    parser.add_argument('--exp_log_path', type=str, required=False, default='')
    args = parser.parse_args()
    ...
    config.set_tag()
    config.exp_log_path = args.exp_log_path
